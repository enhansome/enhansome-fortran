...
A curated list of awesome Fortran frameworks, libraries and software. Inspired by [awesome-swift](https://github.com/Wolg/awesome-swift) ⭐ 5,894 | 🐛 111 | 📅 2026-04-12 by @Wolg.
...
* [OpenBLAS](https://github.com/xianyi/OpenBLAS) ⭐ 7,585 | 🐛 117 | 🌐 C | 📅 2026-09-22 - one of the fastest open source BLAS libraries available.  Almost as fast as Intel MKL.
...
* [json-fortran](https://github.com/jacobwilliams/json-fortran) ⭐ 383 | 🐛 26 | 🌐 Fortran | 📅 2026-06-11 - A Fortran 2008 JSON API.
...
* [ffmt](https://github.com/sbryngelson/ffmt) ⭐ 7 | 🐛 0 | 🌐 Rust | 📅 2026-09-16 - Fast, configurable Fortran formatter with support for Fypp, Doxygen, and OpenACC/OpenMP directives. Written in Rust, installable via pip.
...
* [MFC](https://github.com/MFlowCode/MFC) ⭐ 422 | 🐛 147 | 🌐 Fortran | 📅 2026-09-21 - Exascale multiphase compressible flow solver with GPU acceleration via OpenACC. 2025 Gordon Bell Prize Finalist.
...
Other amazingly awesome lists can be found in the [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,680 | 🐛 66 | 🌐 Ruby | 📅 2024-06-02 list.
