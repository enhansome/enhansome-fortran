...
* [OpenBLAS](https://github.com/xianyi/OpenBLAS) ⭐ 7,567 | 🐛 117 | 🌐 C | 📅 2026-09-01 - one of the fastest open source BLAS libraries available.  Almost as fast as Intel MKL.
...
* [ffmt](https://github.com/sbryngelson/ffmt) ⭐ 6 | 🐛 2 | 🌐 Rust | 📅 2026-09-01 - Fast, configurable Fortran formatter with support for Fypp, Doxygen, and OpenACC/OpenMP directives. Written in Rust, installable via pip.
...
* [MFC](https://github.com/MFlowCode/MFC) ⭐ 414 | 🐛 126 | 🌐 Fortran | 📅 2026-09-01 - Exascale multiphase compressible flow solver with GPU acceleration via OpenACC. 2025 Gordon Bell Prize Finalist.
