...
* [OpenBLAS](https://github.com/xianyi/OpenBLAS) ⭐ 7,582 | 🐛 114 | 🌐 C | 📅 2026-09-11 - one of the fastest open source BLAS libraries available.  Almost as fast as Intel MKL.
* [netCDF](https://github.com/Unidata/netcdf-fortran) ⭐ 269 | 🐛 125 | 🌐 Fortran | 📅 2026-07-29 - a set of software libraries and self-describing, machine-independent data formats that support the creation, access, and sharing of array-oriented scientific data.
...
* [json-fortran](https://github.com/jacobwilliams/json-fortran) ⭐ 382 | 🐛 26 | 🌐 Fortran | 📅 2026-06-11 - A Fortran 2008 JSON API.
...
* [MFC](https://github.com/MFlowCode/MFC) ⭐ 418 | 🐛 127 | 🌐 Fortran | 📅 2026-09-11 - Exascale multiphase compressible flow solver with GPU acceleration via OpenACC. 2025 Gordon Bell Prize Finalist.
...
Other amazingly awesome lists can be found in the [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,664 | 🐛 65 | 🌐 Ruby | 📅 2024-06-02 list.
