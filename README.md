...
* [OpenBLAS](https://github.com/xianyi/OpenBLAS) ⭐ 7,584 | 🐛 117 | 🌐 C | 📅 2026-09-15 - one of the fastest open source BLAS libraries available.  Almost as fast as Intel MKL.
...
* [ffmt](https://github.com/sbryngelson/ffmt) ⭐ 6 | 🐛 1 | 🌐 Rust | 📅 2026-09-12 - Fast, configurable Fortran formatter with support for Fypp, Doxygen, and OpenACC/OpenMP directives. Written in Rust, installable via pip.
...
* [MFC](https://github.com/MFlowCode/MFC) ⭐ 418 | 🐛 142 | 🌐 Fortran | 📅 2026-09-14 - Exascale multiphase compressible flow solver with GPU acceleration via OpenACC. 2025 Gordon Bell Prize Finalist.
...
Other amazingly awesome lists can be found in the [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,674 | 🐛 65 | 🌐 Ruby | 📅 2024-06-02 list.
