...
A curated list of awesome Fortran frameworks, libraries and software. Inspired by [awesome-swift](https://github.com/Wolg/awesome-swift) ⭐ 5,888 | 🐛 111 | 📅 2026-04-12 by @Wolg.
...
* [OpenBLAS](https://github.com/xianyi/OpenBLAS) ⭐ 7,579 | 🐛 114 | 🌐 C | 📅 2026-09-08 - one of the fastest open source BLAS libraries available.  Almost as fast as Intel MKL.
* [netCDF](https://github.com/Unidata/netcdf-fortran) ⭐ 269 | 🐛 124 | 🌐 Fortran | 📅 2026-07-29 - a set of software libraries and self-describing, machine-independent data formats that support the creation, access, and sharing of array-oriented scientific data.
...
* [json-fortran](https://github.com/jacobwilliams/json-fortran) ⭐ 382 | 🐛 25 | 🌐 Fortran | 📅 2026-06-11 - A Fortran 2008 JSON API.
...
* [PENF](https://github.com/szaghi/PENF) ⭐ 43 | 🐛 3 | 🌐 Fortran | 📅 2026-07-01 - Pure Fortran (2003+) library for ensuring codes portability.
...
* [FoBiS](https://github.com/szaghi/FoBiS) ⭐ 144 | 🐛 6 | 🌐 Python | 📅 2026-09-02 - Fortran Building System for poor men. A KISS tool for automatic building modern Fortran projects.
...
* [ffmt](https://github.com/sbryngelson/ffmt) ⭐ 6 | 🐛 1 | 🌐 Rust | 📅 2026-09-02 - Fast, configurable Fortran formatter with support for Fypp, Doxygen, and OpenACC/OpenMP directives. Written in Rust, installable via pip.
...
* [MFC](https://github.com/MFlowCode/MFC) ⭐ 418 | 🐛 121 | 🌐 Fortran | 📅 2026-09-08 - Exascale multiphase compressible flow solver with GPU acceleration via OpenACC. 2025 Gordon Bell Prize Finalist.
...
Other amazingly awesome lists can be found in the [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,660 | 🐛 63 | 🌐 Ruby | 📅 2024-06-02 list.
