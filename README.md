...
* [OpenBLAS](https://github.com/xianyi/OpenBLAS) ⭐ 7,582 | 🐛 121 | 🌐 C | 📅 2026-09-17 - one of the fastest open source BLAS libraries available.  Almost as fast as Intel MKL.
...
* [MFC](https://github.com/MFlowCode/MFC) ⭐ 421 | 🐛 151 | 🌐 Fortran | 📅 2026-09-19 - Exascale multiphase compressible flow solver with GPU acceleration via OpenACC. 2025 Gordon Bell Prize Finalist.
